...
| **11** | **PG 备份可恢复** | **backup_db → shadow DB → SELECT** | **备份文件不可还原** |
| **12** | **外部依赖降级** | **paperless/llm 502/503 行为** | **降级路径是 stack trace** |
| **13** | **HTTP 安全头 + bundle** | **X-CTO/X-FO/HSTS + bundle.js** | **Nginx 配置缺头/资源 404** |
