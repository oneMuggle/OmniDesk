...
def import_book_from_file(uploaded_file, cover_image_file=None, title=None,
                          author='', description='', publication_date=None, tags_str=''):
    ...
    def replace_image_path(match):
        ...
        try:
            ...
            new_path = posixpath.join(
                settings.MEDIA_URL, 'book_images', sanitized_title, image_filename
            )
