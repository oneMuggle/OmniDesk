...
class Sensor(models.Model):
    ...
    sensor_category = models.ForeignKey(
        "SensorCategory", on_delete=models.SET_NULL, null=True, blank=True, verbose_name="传感器类别"
    )
...
class CalibrationReminder(models.Model):
    sensor = models.OneToOneField(
        Sensor, on_delete=models.CASCADE, related_name="calibration_reminder", verbose_name="传感器"
    )
...
class SensorCalibration(models.Model):
    ...
    calibrated_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="calibrations_done",
        verbose_name="校准人",
    )
    reviewed_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="calibrations_reviewed",
        verbose_name="审核人",
    )
...
class CalibrationDataPoint(models.Model):
    sensor_calibration = models.ForeignKey(
        SensorCalibration, on_delete=models.CASCADE, related_name="data_points", verbose_name="传感器校准记录"
    )
