...
class JointStudentSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = JointStudent
        fields = [
            "id", "personnel", "personnel_name", "student_type", "student_type_display",
            "student_id", "enrollment_date", "graduation_date", "mentor", "mentor_name",
...
class MonthlyReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = MonthlyReport
        fields = [
            "id", "joint_student", "student_name", "student_id", "year", "month",
            "work_progress", "work_highlights", "attendance_days_actual",
            "attendance_days_expected", "attendance_notes", "status", "submitted_at",
            "reviewed_at", "reviewer", "reviewer_comment", "created_at", "updated_at",
        ]
        read_only_fields = [
            "status", "submitted_at", "reviewed_at", "reviewer", "created_at", "updated_at",
        ]
...
class AssessmentCycleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            "id", "year", "month", "cycle_start_date", "cycle_end_date", "scoring_deadline",
...
class ExpertScoreSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ExpertScore
        fields = [
            "id", "cycle", "expert", "expert_username", "joint_student", "score", "comment",
...
class StipendRecordSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = StipendRecord
        fields = [
            "id", "cycle", "joint_student", "student_name", "student_id", "student_type",
            "average_score", "rank_in_cycle", "grade", "grade_display", "base_amount",
            "grade_coefficient", "attendance_ratio", "final_amount", "status", "locked_at",
            "locked_by", "notes", "created_at", "updated_at",
        ]
        read_only_fields = [
            "cycle", "joint_student", "average_score", "rank_in_cycle", "grade", "base_amount",
            "grade_coefficient", "attendance_ratio", "final_amount", "status", "locked_at",
