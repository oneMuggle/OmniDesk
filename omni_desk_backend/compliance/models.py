...
class ComplianceIssue(models.Model):
    project = models.ForeignKey(
        Project, on_delete=models.CASCADE, related_name="compliance_issues", verbose_name="所属项目"
    )
    ...
    issue_type = models.CharField(max_length=50, choices=ISSUE_TYPES, verbose_name="问题类型")
    description = models.TextField(verbose_name="问题描述")
    location = models.CharField(max_length=255, blank=True, verbose_name="问题位置")  # 例如：页码、段落、图片区域
    ...
    severity = models.CharField(max_length=50, choices=SEVERITY_CHOICES, default="中", verbose_name="严重程度")
