...
export const getPersonnelSequenceDetails = (id) => {
  return apiClient.get(`events/personnel-sequences/${id}/`);
};

// 创建人员顺序
export const createPersonnelSequence = (data) => {
  return apiClient.post('events/personnel-sequences/', data);
};

// 更新人员顺序
export const updatePersonnelSequence = (id, data) => {
  return apiClient.put(`events/personnel-sequences/${id}/`, data);
};
...
export const getLeaderSequenceDetails = (id) => {
  return apiClient.get(`events/leader-sequences/${id}/`);
};

// 创建领导顺序
export const createLeaderSequence = (data) => {
  return apiClient.post('events/leader-sequences/', data);
};

// 更新领导顺序
export const updateLeaderSequence = (id, data) => {
  return apiClient.put(`events/leader-sequences/${id}/`, data);
};
