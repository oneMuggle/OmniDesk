...
const allAdminMenuItems = [
  ...
  { to: "/control-panel/schedule", icon: faCalendarAlt, text: "排班管理", permission: "events.view_schedule" },
  { to: "/control-panel/users", icon: faUsers, text: "用户管理", permission: "users.view_customuser" },
  { to: "/control-panel/sensors", icon: faFlask, text: "传感器管理", permission: "sensors.view_sensor" },
  { to: "/control-panel/ebooks", icon: faBook, text: "电子书管理", permission: "documents.view_ebook" },
  { to: "/control-panel/announcements/manage", icon: faBullhorn, text: "公告管理", permission: "events.view_announcement" },
  { to: "/control-panel/dify-apps", icon: faCog, text: "Dify 应用管理", permission: "dify_apps.view_difyapp" },
  { to: "/control-panel/schedule/settings", icon: faCog, text: "排班设置", permission: "events.view_personnelsequence" },
  { to: "/control-panel/meeting-rooms", icon: faCog, text: "会议室管理", permission: "meeting_rooms.view_meetingroom" },
  { to: "/control-panel/schedule/holiday", icon: faCalendarAlt, text: "节假日管理", permission: "events.view_holiday" },
  { to: "/control-panel/news/stats", icon: faNewspaper, text: "新闻统计", permission: "news.view_news" },
  { to: "/control-panel/news", icon: faNewspaper, text: "新闻管理", permission: "news.view_news" },
  { to: "/control-panel/projects", icon: faFlask, text: "项目管理", permission: "admin" },
